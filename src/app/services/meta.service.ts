...
export class MetaService {
  ...
  private addTwitterTags(title: string, description: string) {
    ...
    this.meta.addTag({ name: 'twitter:image', content: 'https://34.36.144.117/destacados-extra.webp' })
  }
  ...
  private addFacebookTags(title: string, description: string, canonical: string) {
        ...
        this.meta.addTag({ property: 'og:image', content: 'https://34.36.144.117/destacados-extra.webp'})
  }
