...
export class ConoceAlPugCarlinoLaRazaDePerroMasAdorableComponent {
   ...
   title = '¡Conoce al Pug Carlino, la Raza de Perro Más Adorable! 🐶'
   description = 'Descubre todo lo que necesitas saber sobre el Pug Carlino, la raza de perro más adorable. ¡Echa un vistazo a las características y con qué cuidados cuenta esta hermosa raza de perro! 🐩'
